export const initialData = [
  ...
  },
  {
    ...
    subtitle: "Schwarz",
    coverImg: "https://covers.openlibrary.org/b/id/9324956-L.jpg",
    isbn10: "3-453-87556-7",
    teaser:
  ...
  },
  {
    ...
    title: "Der dunkle Turm",
    subtitle: "Tot",
    coverImg: "https://covers.openlibrary.org/b/id/10515631-L.jpg",
    isbn10: "3-453-87558-3",
    teaser:
      "Am Anfang von tot. verlassen Roland, Eddie, ein ehemaliger Junkie aus New York und Susannah, eine Symbiose der beiden Charaktere aus der schizophrenen Odetta, das Westliche Meer und betreten einen großen, alten Wald. Roland lehrt Eddie und Susannah die Grundregeln des Revolvermanntums. Beide lernen schnell und das müssen sie auch, denn sie werden von Shardik, einem uralten, gigantischen Cyborg-Bären angegriffen, der vom Alten Volk damit beauftragt wurde, ein Portal des Balkens zu beschützen. Alles in allem gibt es zwölf solcher Portale in Rolands Welt, die alle von einem anderen Tier bewacht werden. Diese Portale sind zugleich Anfangs- und Endpunkt von sechs Balken, die fast unsichtbar, aber trotzdem mächtiger als vieles andere auf der Welt, in ihrer Mitte zusammenlaufen und dort den Dunklen Turm stützen. Sie besiegen Shardik schließlich, indem sie die Antenne auf dessen riesigen Kopf abschießen und folgen dem Pfad des Balkens in Richtung des dunklen Turmes. Roland hat in der dritten Tür in „Drei“ den Mann getötet, der den jungen Jake vor ein Auto stoßen sollte, bevor er selbst ihn genau davon abgehalten hat.",
  },
  {
    id: 7,
    isActive: true,
    ...
    title: "Der dunkle Turm",
    subtitle: "Glas",
    coverImg: "https://covers.openlibrary.org/b/id/1009068-L.jpg",
    isbn10: "3-453-87559-1",
    teaser:
      "Das Buch beginnt mit der Fortsetzung des Rätselwettbewerbs. Dieser endet damit, dass Eddie sich den Kopf zerbricht und letztendlich Blaine den Mono mit Unlogik besiegt (Wie kam das tote Baby überhaupt auf die Straße? Weil es auf dem Huhn festgetackert war.). Der Revolvermann, welcher zuvor die „blöden“ Rätsel verschmäht hatte, muss nun anerkennen, dass selbst Unlogik manchmal weiterhilft. Die Reise endet damit, dass der schizophrenen Intelligenz namens Blaine die dipolaren Schaltkreise durchbrennen, was Eddie mit mehreren Schüssen in den Computer von Blaine noch beschleunigt, und der Zug so noch rechtzeitig zum Stillstand kommt.",
  },
];
